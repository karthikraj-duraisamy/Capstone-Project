...
public class ArticlesProvider extends ContentProvider {
    ...
    private static final int ARTICLES_WITH_ID = 200;
    ////////
    ...
    private static UriMatcher buildUriMatcher(){
        ...
        matcher.addURI(authority, ArticlesContract.ArticleEntry.TABLE_ARTICLES, ARTICLES);
        matcher.addURI(authority, ArticlesContract.ArticleEntry.TABLE_ARTICLES + "/#", ARTICLES_WITH_ID);
