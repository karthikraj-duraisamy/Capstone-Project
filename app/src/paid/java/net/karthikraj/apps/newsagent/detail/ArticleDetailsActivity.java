...
public class ArticleDetailsActivity extends AppCompatActivity {
    ...
    public final static String TAG = ArticleDetailsActivity.class.getSimpleName();
    ...
    private void addToLikesTable() {
        ...
        mLikeButton.setImageResource(R.drawable.ic_heart);
        Snackbar.make(bodyView, getString(R.string.alert_msg_likes_addition_success), Snackbar.LENGTH_LONG).setAction(getString(R.string.action_remove), new View.OnClickListener() {
            @Override
    ...
    private void removeFromLikesTable() {
        ...
        mLikeButton.setImageResource(R.drawable.ic_heart_outline);
        Snackbar.make(bodyView, getString(R.string.alert_likes_remove_success), Snackbar.LENGTH_LONG).setAction(getString(R.string.action_add_again), new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                addToLikesTable();
            }
